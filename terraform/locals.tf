locals {
  ...
  webdeploy_topic_name                  = "${var.webdeploy_topic_name}-${local.environment_suffix}"
  webdeploy_subscription_name           = "${var.webdeploy_subscription_name}-${local.environment_suffix}"
  webdeploy_dead_letter_topic_name      = "${var.webdeploy_dead_letter_topic_name}-${local.environment_suffix}"
  webdeploy_dead_letter_subscription_name = "${var.webdeploy_dead_letter_subscription_name}-${local.environment_suffix}"
  ...
  agent_logs_bucket_name             = "${var.agent_logs_bucket_name}-${local.environment_suffix}"

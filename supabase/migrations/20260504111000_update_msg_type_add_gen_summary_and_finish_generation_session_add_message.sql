-- ============================================================
-- Update:
-- - Extend msg_type enum with 'gen_summary'
-- - Update finish_generation_session() to write a generation summary message
-- ============================================================

-- Add new message type for generation summary messages
alter type public.msg_type add value if not exists 'gen_summary';

-- Replace the 4-arg function to also insert a summary message into public.messages
...
begin
    ...
    -- Write generation summary message
